  ...
  for (const event of events) {
    switch (event.type) {
      ...
      case 'police':
        ...
        break;
      case 'calebPickup':
        // TODO(PLAN-06 task C): handles.push(createPickup(scene, event, ctx))
        // — level 12's mid-level auto-brake cutscene, then ctx.passenger
        // .activate() so Caleb rides pillion for the rest of the game.
        handles.push(inertHandle());
        break;
      case 'wheelieRider':
